(ns core-service.core.consumers.jetstream
...
(defmethod ig/init-key :core-service.core.consumers.jetstream/runtime
...
(defmethod ig/halt-key! :core-service.core.consumers.jetstream/runtime
