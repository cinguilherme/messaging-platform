(ns core-service.core.consumers.kafka
...
(defmethod ig/init-key :core-service.core.consumers.kafka/runtime
...
(defmethod ig/halt-key! :core-service.core.consumers.kafka/runtime
