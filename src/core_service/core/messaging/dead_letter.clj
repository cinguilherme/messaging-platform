(ns core-service.core.messaging.dead-letter
...
(defmethod ig/init-key :core-service.core.messaging.dead-letter/logger
  [_ {:keys [logger]}]
...
(defmethod ig/init-key :core-service.core.messaging.dead-letter/storage
...
(defmethod ig/init-key :core-service.core.messaging.dead-letter/producer
...
(defmethod ig/init-key :core-service.core.messaging.dead-letter/common
