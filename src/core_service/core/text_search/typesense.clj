(ns core-service.core.text-search.typesense
  (:require [integrant.core :as ig]
            [core-service.core.clients.typesense.client :as tc]
            [core-service.core.text-search.protocol :as p]))
...
(defmethod ig/init-key :core-service.core.text-search.typesense/engine
